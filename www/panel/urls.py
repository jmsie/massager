...
from .views import login_view, logout_view, portal_home, manage_therapists, manage_surveys, manage_massage_plans
...
urlpatterns = [
    ...
    path('manage-massage-plans/', manage_massage_plans, name='manage_massage_plans'),  # 新增這行
